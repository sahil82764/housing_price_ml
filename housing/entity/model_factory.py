...
GridSearchedBestModel = namedtuple('GridSearchBestModel', [ "model_serial_number", "model", "best_model", "best_parameters", "best_score"])
...
class ModelFactory:
    ...
    def __init__(self, model_config_path: str=None):
        try:
            ...
            self.grid_search_cv_model: str = self.config[GRID_SEARCH_KEY][MODULE_KEY]
    ...
    def class_for_name(module_name:str, class_name:str):
        try:
            #load the module, will raise ImportError if not found
            module = importlib.import_module(module_name)
            #get the class, will raise AttributeError if not found
    ...
    def execute_grid_search_operation(self, initialized_model: InitializedModelDetail, input_feature, output_feature) -> GridSearchedBestModel:
        ...
        try:
            ...
            grid_search_cv_ref = ModelFactory.class_for_name(module_name=self.grid_search_cv_model, class_name= self.grid_search_class_name)
